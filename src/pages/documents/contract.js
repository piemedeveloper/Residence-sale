...
function Contract(props) {
  ...
  const recitals = [
    ...
    `WHEREAS the Investor intends to owning a stake in <b>${details.unit}</b> of Pieme Residences which shall include the structure and all the furnishing therein (the "<b>Housing Unit</b>") being the subject of this Agreement;`,
      ...
      sub_menu: [
        {
          ...
          description: [
            ...
            for <b>${
              details.percentage
            } Percent (%)</b> ownership in the Housing Unit which contribution is inclusive of the cost of furnishing the Housing Unit.`,
          ],
        },
        {
          title: "",
    ...
    <>
      ...
      <div className="w-full mx-auto contract-doc" id="capture">
        ...
        <ol className="numbered">
          <li>
            <b>PIE TECH LIMITED</b> (Pieme Residences) (the "<b>Company</b>"), a
            Ugandan corporation of P.O.BOX 131257 Kampala GPO, with its
        ...
        <p>
          ...
          agreements set forth hereafter, the Parties hereby agree as follows:
        </p>
